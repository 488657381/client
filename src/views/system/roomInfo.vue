...
<el-table-column fixed="right" prop="roomOpenStatus" label="开播状态" />
  ...
  <el-table height="550" :data="tableData.roomInfoList" style="width: 100%">
    <el-table-column prop="roomId" label="大厅编号" width="80">
      <template #default="scope">
        <el-tag type="success">{{ scope.row.roomId }}</el-tag>
      </template>
    </el-table-column>
    <el-table-column prop="roomName" label="大厅名称" width="150"/>
    <el-table-column prop="roomCategoryL1" label="一级编号" width="120"/>
    <el-table-column prop="categoryNameLevel1" label="一级名称" width="150">
      <template #default="scope">
        <el-tag type="warning">{{ scope.row.categoryNameLevel1 }}</el-tag>
      </template>
    </el-table-column>
    <el-table-column prop="roomCategoryL2" label="二级编号" width="120"/>
    <el-table-column prop="categoryNameLevel2" label="二级名称" width="120">
      <template #default="scope">
        <el-tag type="info">{{ scope.row.categoryNameLevel2 }}</el-tag>
      </template>
    </el-table-column>

    <el-table-column prop="roomOwnerCustomer" label="房主编号" width="120"/>
    <el-table-column prop="nickname" label="房主名称" width="150"/>
    <el-table-column prop="roomNotice" label="房间公告" width="150">
      <template #default="scope">
    ...
    <el-table-column prop="roomPush" label="推荐状态" width="150">
      <template #default="scope">
    ...
    <el-table-column label="操作" fixed="right" style="width: 250px;">
      <template #default="scope">
        <el-button style="width: 30px;" type="info" @click="openUpdateDialog(scope.row)">修改</el-button>
        <el-button style="width: 30px;" type="info" @click="openDeleteTip(scope.row.roomId)">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
  <el-pagination
